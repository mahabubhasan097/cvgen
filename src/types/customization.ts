import { getTemplateSections } from '@/constants/templateSections';
...
export const DEFAULT_CUSTOMIZATION: CustomizationSettings = {
  ...
  sections: getTemplateSections('professional-standard'),
  showIcons: true,
  iconSize: 14,
...
/**
 * Get customization settings for a specific template
 * This ensures each template has its own section configuration
 */
