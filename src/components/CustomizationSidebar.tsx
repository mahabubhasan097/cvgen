...
const CustomizationSidebar: React.FC<CustomizationSidebarProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    'templates' | 'quick' | 'advanced' | 'sections'
  >('templates');
              ...
              <div className='space-y-8'>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      onUpdate({ ...settings, fontFamily: e.target.value })
                    }
                ...
                <div>
                  ...
                  <div className='grid grid-cols-3 gap-2'>
                    {(['underline', 'background', 'border'] as const).map(
                      style => (
                        <button
                          key={style}
                          onClick={() =>
                ...
                <div>
                  <label className='flex items-center justify-between'>
                    ...
                    <input
                      ...
                      onChange={e =>
                        onUpdate({ ...settings, showIcons: e.target.checked })
                      }
                  ...
                  <div className='grid grid-cols-3 gap-2'>
                    {(['disc', 'circle', 'square'] as const).map(style => (
                      <button
                        key={style}
                        onClick={() =>
                          onUpdate({ ...settings, bulletStyle: style })
                        }
                ...
                <div>
                  ...
                  <div className='grid grid-cols-3 gap-2'>
                    {(['normal', 'uppercase', 'capitalize'] as const).map(
                      caseStyle => (
                        <button
                          key={caseStyle}
                          onClick={() =>
                            onUpdate({ ...settings, headingCase: caseStyle })
                          }
                ...
                <div>
                  ...
                  <button
                    onClick={() =>
                      onUpdate({
                        ...settings,
                        accentColor: settings.theme.primary,
                      })
                    }
                  ...
                  <div className='space-y-3'>
                    ...
                    <div>
                      <label className='text-xs font-medium text-gray-700 flex justify-between mb-1'>
                        ...
                        <span className='text-indigo-600'>
                          {settings.fontSize.subheading || 15}px
                        </span>
                      </label>
                      <input
                        type='range'
                    ...
                    <div>
                      <label className='text-xs font-medium text-gray-700 flex justify-between mb-1'>
                        ...
                        <span className='text-indigo-600'>
                          {settings.fontSize.caption || 11}px
                        </span>
                      </label>
                      <input
                        type='range'
                  ...
                  <div className='space-y-3'>
                    <div>
                      <label className='text-xs font-medium text-gray-700 flex justify-between mb-1'>
                        <span>Headings</span>
                        <span className='text-indigo-600'>
                          {settings.lineHeight.heading.toFixed(1)}
                        </span>
                      </label>
                      <input
                        type='range'
                    ...
                    <div>
                      <label className='text-xs font-medium text-gray-700 flex justify-between mb-1'>
                        <span>Body Text</span>
                        <span className='text-indigo-600'>
                          {settings.lineHeight.body.toFixed(1)}
                        </span>
                      </label>
                      <input
                        type='range'
                    ...
                    <div>
                      <label className='text-xs font-medium text-gray-700 flex justify-between mb-1'>
                        <span>Lists</span>
                        <span className='text-indigo-600'>
                          {settings.lineHeight.list.toFixed(1)}
                        </span>
                      </label>
                      <input
                        type='range'
                        ...
                        onChange={e =>
                          onUpdate({
                            ...
                            lineHeight: {
                              ...settings.lineHeight,
                              list: parseFloat(e.target.value),
                            },
                          })
                        }
                        className='w-full'
                  ...
                  <div className='space-y-3'>
                    ...
                    <div>
                      <label className='text-xs font-medium text-gray-700 flex justify-between mb-1'>
                        ...
                        <span className='text-indigo-600'>
                          {settings.spacing.letterSpacing}px
                        </span>
                      </label>
                      <input
                        type='range'
                    ...
                    <div>
                      <label className='text-xs font-medium text-gray-700 flex justify-between mb-1'>
                        ...
                        <span className='text-indigo-600'>
                          {settings.spacing.pageMargin}px
                        </span>
                      </label>
                      <input
                        type='range'
