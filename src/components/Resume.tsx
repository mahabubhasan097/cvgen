            ...
            >
                      ...
                      <li key={achIndex} className="group-item relative">
                        {(customization.bulletStyle === "arrow" || customization.bulletStyle === "chevron") && (
                          <span 
                            ...
                            style={{ color: customization.accentColor || customization.theme.primary }}
                          >
              ...
              {isEditable && (
                <button
                  ...
                  className="mt-4 w-full py-2 border-2 border-dashed border-gray-300 hover:border-blue-500 hover:bg-blue-50 rounded-lg text-sm font-medium text-gray-600 hover:text-blue-600 transition-all no-print flex items-center justify-center gap-2"
                >
                ...
                <div key={edu.id} className="mb-3 last:mb-0 group relative">
                  ...
                  {isEditable && !edu.gpa && (
                    <button
                      ...
                      className="mt-1 text-xs text-blue-600 hover:text-blue-700 flex items-center gap-1 no-print"
                    >
            ...
            >
              ...
              >
                {(data.certifications && data.certifications.length > 0) ? data.certifications.map((cert, index) => (
                      ...
                      <>
                        ...
                        {!cert.credentialId && (
                          <button
                            ...
                            className="ml-2 text-xs text-blue-600 hover:text-blue-700 no-print"
                          >
                            + Add ID
                          </button>
                        )}
                  ...
                  <p className="text-sm text-gray-500 italic">No certifications added yet. Click "Add Certification" below.</p>
                )}
              </div>
              {isEditable && (
                <button
            ...
            >
              ...
              >
                {(data.projects && data.projects.length > 0) ? data.projects.map((project, index) => (
                  <div key={project.id} className="mb-3 last:mb-0 group relative">
                    ...
                    {isEditable ? (
                      <>
                        ...
                        {!project.link && (
                          <button
                            ...
                            className="mt-2 text-xs text-blue-600 hover:text-blue-700 flex items-center gap-1 no-print"
                          >
                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <>
                        ...
                        <p className="text-gray-700 mt-1.5 leading-relaxed" style={{ lineHeight: '1.6' }}>{project.description}</p>
                        <div className="text-sm text-gray-600 mt-2">
                          <span className="font-semibold">Technologies: </span>
                  ...
                  <p className="text-sm text-gray-500 italic">No projects added yet. Click "Add Project" below.</p>
                )}
              </div>
              {isEditable && (
                <button
    ...
    return (
      ...
      >
        ...
        <header className="mb-5">
          ...
          <div className="flex flex-wrap gap-3 text-xs text-gray-700 items-center print:hidden">
            {isEditable ? (
              <>
                <span className="flex items-center gap-1">
                  {customization.showIcons && (
                    <svg style={{ width: `${customization.iconSize}px`, height: `${customization.iconSize}px` }} className="text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {data.contact.linkedin && (
                  <span className="flex items-center gap-1">
                    {customization.showIcons && (
                      <svg style={{ width: `${customization.iconSize}px`, height: `${customization.iconSize}px` }} className="text-gray-500" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="hidden print:flex flex-wrap gap-3 text-xs items-center" style={{ marginTop: '0.25rem' }}>
            <span className="flex items-center gap-1">
              {customization.showIcons && (
                <svg style={{ width: `${customization.iconSize}px`, height: `${customization.iconSize}px` }} className="text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            ...
            <div className="mt-3 flex flex-wrap gap-2 no-print">
              {!data.contact.linkedin && (
                <button
                  ...
                  className="text-xs px-3 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-full font-medium transition-colors flex items-center gap-1"
                >
              ...
              {!data.contact.github && (
                <button
                  ...
                  className="text-xs px-3 py-1.5 bg-gray-50 hover:bg-gray-100 text-gray-700 rounded-full font-medium transition-colors flex items-center gap-1"
                >
                  <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                    <path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clipRule="evenodd" />
                  </svg>
